...
const BEATS = {
  small:  ['large', 'tower'],  // small beats large and tower
  large:  ['medium'],          // large beats medium only
  medium: ['small', 'tower'],  // medium beats small and tower
  tower:  [],                  // towers cannot attack
};
...
const turnMoves      = new Map(); // unitId → { fromRow, fromCol, capturedUnit }
const turnPlacements = new Set(); // unitIds placed this turn
...
placeInitialUnit('medium', 1, 2, 1);
placeInitialUnit('medium', 2, 1, 1);
placeInitialUnit('medium', 17, 18, 2);
placeInitialUnit('medium', 18, 17, 2);

startTurn(); // collect player 1 income and snapshot

module.exports = {
  // Game actions
  getState, addUnit, moveUnit, undoUnitMove, undoUnitPlacement,
  restartTurn, submitTurn,
  // Test utilities
  resetState, placeInitialUnit, startTurn,
  // Constants
  BOARD_SIZE, BEATS, UNIT_COSTS,
};
